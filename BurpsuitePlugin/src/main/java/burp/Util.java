...
public class Util {
    ...
    public static String Test(){
        String test = "[+] WebServer: " + Config.getWebServerURL() + " \n"
                ...
                + "[+] Request  functions3: "+ Config.getReqfunc3()+"\n"
                + "[+] Request  functions4: "+ Config.getReqfunc4()+"\n"
                + "[+] Request  functions5: "+ Config.getReqfunc5()+"\n"
                + "[+] Response functions6: "+ Config.getRespfunc1()+"\n"
                + "[+] Response functions7: "+ Config.getRespfunc2()+"\n"
